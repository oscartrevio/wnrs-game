<template>
  ...
  <content
    class="h-max w-full space-y-10 my-auto absolute inset-y-1/2 -z-10 touch-manipulation"
  >
  ...
  <footer class="h-full w-full z-10">
    <div class="container">
      <NavBar />
    </div>
  </footer>
  ...
  data() {
    return {
      ...
      levelTwo: [
        ...
        "WILDCARD. STARING CONTEST! FIRST TO SMILE OR LOOK AWAY HAS TO SHOW AN EMBARRASSING VIDEO, AT LEAST 3 YEARS OLD.",
        "WHAT MOVIE DO YOU WISH YOU COULD WATCH AGAIN FOR THE FIRST TIME, WHY? EXPLAIN.",
        "WILDCARD. REVEAL YOUR MOST PLAYED SONG, AT THE MOMENT. EXPLAIN.",
        ...
        "WILDCARD. WRITE A NOTE TO YOUR YOUNGER SELVES. AFTER 1 MINUTE, OPEN AND COMPARE.",
        ...
        "WILDCARD. SING YOUR FAVOURITE SONG LYRICS OFF THE TOP OF YOUR HEAD. BOTH PLAYERS.",
        ...
        "WILDCARD. WHAT IS YOUR FAVOURITE MEMORY WE SHARE TOGETHER? BOTH PLAYERS. COMPARE.",
        ...
        "WILDCARD. WRITE DOWN THE THREE MOST IMPORTANT THINGS TO YOU IN A RELATIONSHIP. COMPARE.",
        "WHAT'S THE MOST EMBARRASSING THING THAT'S EVER HAPPENED TO YOU?",
        "WHAT COULD YOU HAVE DONE BETTER IN YOUR PREVIOUS RELATIONSHIP(S)?",
        "WILDCARD. ADMIT A DATING PET PEEVE. COMPARE.",
        "FINISH THE SENTENCE: DATING IS _____.",
        "WHAT DID THE PEOPLE WHO RAISED YOU TEACH YOU ABOUT LOVE?",
        "DESCRIBE YOUR PERFECT DATE.",
        "WILDCARD. CREATE YOUR OWN QUESTION. ANYTHING. MAKE IT COUNT.",
        "WHAT ARE YOU PASSIONATE ABOUT?",
        "WHAT ARE YOU NOT GIVING ENOUGH TIME TO, CURRENTLY?",
        "WHEN'S THE LAST TIME YOU SURPRISED YOURSELF?",
        "WILDCARD. THINK OF A MOVIE THAT ALWAYS MAKES YOU CRY. ON THE COUNT OF 3, SAY YOUR ANSWERS OUT LOUD.",
        ...
        "WILDCARD. DO YOU NEED ADVICE ON ANYTHING IN YOUR LIFE RIGHT NOW? PERMISSION TO VENT.",
        "WILDCARD. WRITE DOWN THE THREE MOST IMPORTANT QUALITIES IN A BEST FRIEND. COMPARE.",
        ...
        "WILDCARD. WHO'S BEEN ON YOUR MIND LATELY? SEND THEM A TEXT LETTING THEM KNOW YOU'RE THINKING OF THEM.",
      ...
      levelThree: [
        ...
        "WILDCARD. WRITE A MOTIVATIONAL REMINDER TO YOUR PARTNER. FOLD AND EXCHANGE. OPEN WHEN NEEDED.",
        "WILDCARD. BOTH PLAYERS WRITE DOWN YOUR NUMBER ONE GOAL FOR THE NEXT MONTH. EXCHANGE.",
        "WILDCARD. SHARE A MEANINGFUL HUG WITH YOUR PARTNER. 1 MINUTE.",
